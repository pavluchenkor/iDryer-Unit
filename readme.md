...
# iDyer Unit - cистема  сушки пластика для 3D-принтеров на базе Klipper
...
- **Мастер-слейв архитектура**: Одна сушилка оснащена MCU и выступает в роли мастера, остальные сушилки являются слейвами.
- **Подключение слейвов**: Слейвы подключаются к мастеру с помощью патчкордов через Ethernet-разъёмы для надёжной связи.
...
- **Интерфейсы подключения**: Ethernet-разъёмы используются для соединения между сушилками, что упрощает монтаж и обеспечивает надёжное соединение.

## Установка и настройка

1. **Сборка оборудования**: Соберите мастер-сушилку с MCU и необходимые слейвы.
2. **Подключение**: Соедините слейвы с мастером с помощью патчкордов через Ethernet-разъёмы.
...
- Ethernet-патчкорды и разъёмы для подключения слейвов к мастеру.
